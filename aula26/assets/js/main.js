function main() {
  ...
  function calculateIMC(event) {
    ...
    const imc = formWeight / (formHeight ** 2);
    ...
    if (formWeight > 200)
      ...
      if (formHeight > 3)
        ...
        if (imc < 18.5)
          res.innerHTML = `<p>Seu IMC é <b>${imc.toFixed(2)}</b> (Abaixo do peso)</p>`;
        else if (imc < 24.9)
          res.innerHTML = `<p>Seu IMC é <b>${imc.toFixed(2)}</b> (Peso normal)</p>`;
        else if (imc < 29.9)
          res.innerHTML = `<p>Seu IMC é <b>${imc.toFixed(2)}</b> (Sobrepeso)</p>`;
        else if (imc < 34.9)
          res.innerHTML = `<p>Seu IMC é <b>${imc.toFixed(2)}</b> (Obesidade de grau 1)</p>`;
        else if (imc < 39.9)
          res.innerHTML = `<p>Seu IMC é <b>${imc.toFixed(2)}</b> (Obesidade de grau 2)</p>`;
        else
          res.innerHTML = `<p>Seu IMC é <b>${imc.toFixed(2)}</b> (Obesidade de grau 3)</p>`;
      }
